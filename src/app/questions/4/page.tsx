    ...
    <div className="min-h-screen bg-gray-900 flex flex-col items-center justify-center p-4">
      ...
      >
        ...
        >
          ...
          <p className="animate-pulse text-purple-400 mb-4">
            {" "}
            🧐 Inspect Everything
          </p>
          ...
          {showHint && (
            <div className="bg-gray-800 p-3 rounded-lg mb-4 text-sm text-gray-300">
              <p>
                💡 Hint: The answer is hidden in the source code link attribute
              </p>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {error && (
              <p className="text-red-400 text-sm animate-bounce">{error}</p>
            )}
